...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Alex Morgan",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-founder-headshot-set-in-a.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"We started Freequency because we were tired of building communities that platforms controlled. Brands do the work—why don't they own the results?"`}
			/>
